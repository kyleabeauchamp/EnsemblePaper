...
The end result is a collection of `landscape-tilted' ensembles (Fig. \ref{figure:Ambiguity}b). That is, each conformational ensemble is a perturbed version of the initial molecular dynamics ensemble but reweighted (see Appx. S2) according to energetic perturbations that are linear in the experimental observables $f_i(x)$:
